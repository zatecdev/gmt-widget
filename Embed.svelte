...
<div class="widget-container">
    <!-- render a type of widget based on the type -->
    ...
    <p>
        {customer.name} Planted<br />
        <span class="tree-counter">{customer.trees}</span><br />
        Tree(s)<br />
        <span class="small-inprint">Brought to you by ImpactHero</span>
    </p>
</div>
